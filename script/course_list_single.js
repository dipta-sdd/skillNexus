...
$(document).ready(function () {
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="lecture-links mb-2">
                                        ...
                                        <a href="/student_view_lec_detail?${courseId}&${lecture.id}" class="btn btn-sm btn-outline-secondary">View Lecture</a>
                                    </div>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text my-color">This lecture is locked. Please enroll to access.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function updateEnrollmentButton(courseId, enrolled) {
        ...
        if (enrolled) {
            container.html('<button class="btn btn-secondary" disabled>Already Enrolled</button>');
        } else {
            container.html(`<a href="#" class="btn btn-primary enroll-btn" data-course-id="${courseId}">Enroll Now</a>`);
