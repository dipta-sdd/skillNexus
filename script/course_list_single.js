...
$(document).ready(function () {
    ...
    $(document).on('click', '.enroll-btn', function(e) {
        ...
        // Confirm enrollment
        $('#addTrainModel .btn-secondary').on('click', async function() {
            try {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $(`.enroll-btn[data-course-id="${courseId}"]`).replaceWith('<button class="btn btn-secondary" disabled>Already Enrolled</button>');
                    },
                    error: function (error) {
