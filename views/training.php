        ...
        <nav aria-label="breadcrumb" class="mybg-t breadcrumb">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class=" mb-3 col-lg-6">
                        ...
                        <input class="form-control py-0 form-control-sm " name="title" placeholder="Training Title"/>
                      </div>

                      <div class=" mb-3 col-lg-6">
                        <label class="my-color">Institution Name
                          <span class="text-danger">*</span></label>
                        <input class="form-control py-0 form-control-sm" name="institution_name" placeholder="Institution Name"/>
                      </div>

                      <div class=" mb-3 col-lg-6">
                        <label class="my-color">Country
                          <span class="text-danger">*</span></label>
                        <input class="form-control py-0 form-control-sm " name="country" placeholder="Country" list="country"/>
                        <datalist id="country">
                            <!-- <option value="Black">
                            <option value="Red">
                            <option value="Green">
          ...
          <div class="row my-color mybg my-row" id="training">
            <div class="d-flex">
              ...
              <div class="mb-2">
                <button type="button" class="btn btn-outline-primary btn-add" data-bs-toggle="modal" data-bs-target="#addTrainModel">
