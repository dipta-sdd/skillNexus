      ...
      <div class="my-round" id="body"  data-bs-theme="light">
        <nav aria-label="breadcrumb" class="mybg-t breadcrumb">
          ...
          <!-- Button trigger modal -->
            ...
            <!-- Modal -->
            <div class="modal fade modal-lg" style="z-index: 6000" id="addExperienceModel" tabindex="-1" aria-labelledby="myModel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class=" mb-3 col-lg-6">
                        ...
                        <input class="form-control py-0 form-control-sm" name="organisation_name" placeholder="Organisation Name"/>
                      </div>

                      <div class=" mb-3 col-lg-6">
                        <label class="my-color">Designation
                          <span class="text-danger">*</span></label>
                        <input class="form-control py-0 form-control-sm " name="designation" placeholder="Designation"/>
                      </div>
                      <div class=" mb-3 col-lg-6">
                        <label class="my-color">Department
                          <span class="text-danger">*</span></label>
                        <input class="form-control py-0 form-control-sm " name="department" placeholder="Department"/>
                      </div>
                      ...
                      <div class=" mb-3 col-lg-6">
                        <label class="my-color">Location
                          <span class="text-danger">*</span></label>
                        <input class="form-control py-0 form-control-sm " name="location" placeholder="Location" list="location"/>
                            ...
                            <div class="row">
                              <div class=" mb-3 col-4">
                                <label class="my-color">Year
                                  <span class="text-danger">*</span></label>
                                <select class="form-control form-select py-0 form-control-sm " name="duration_year" >
                                  <option value=""></option>
                              ...
                              <div class=" mb-3 col-4">
                                <label class="my-color">Month
                                  <span class="text-danger">*</span></label>
                                <select class="form-control form-select py-0 form-control-sm" name="duration_month" >
                                  <option value=""></option>
                                  <option value="0">0</option>
                                  <option value="1">1</option>
                                  <option value="2">2</option>
                              ...
                              <div class=" mb-3 col-4">
                                <label class="my-color">Day
                                  <span class="text-danger">*</span></label>
                                <select class="form-control form-select py-0 form-control-sm" name="duration_day" >
                                  <option value=""></option>
                                  <option value="0">0</option>
                                  <option value="1">1</option>
                                  <option value="2">2</option>
          ...
          <div class="row my-color mybg my-row">
            <div class="d-flex">
              ...
              <div class="mb-2">
                <button type="button" class="btn btn-outline-primary btn-add" data-bs-toggle="modal" data-bs-target="#addExperienceModel">
